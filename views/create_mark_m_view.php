    ...
    <div class="panel-body">
        ...
        <form action="create_make" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="createMake" name="create_make_name" value="" placeholder="Brand Name" required/>
            </div>
            <input type="hidden" id="createMake" name="create_make">
