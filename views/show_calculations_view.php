            ...
            foreach ($data['calculations'] as $calc) {
                ...
                echo <<<HTML
                    <tr>
                        ...
                        <td style='vertical-align: middle;' class="text-center">
                            $calc[transport_buitenland]
                        </td>

                        <td style='vertical-align: middle;' class="text-center">
                            $calc[transport_binnenland]
                        </td>
                        ...
                        <td style='vertical-align: middle;' class="text-center">
                            ...
                            <form action="calculation" method="POST" >
                                <input type="hidden" name="calculation_id" value="$calc[calclulation_id]" />
                ...
                HTML;
                                    foreach ($data['cars'] as $car) {
                                       ...
                                       if( $calc['calculation_for_car_id'] == $car['carID'][0] ) {
                                        ...
                                        echo <<<HTML
                                        <option $selected value="{$car['carID'][0]}"> {$car['carID'][0]}:  {$car['name'][0]} {$car['name'][1]} - {$car['motor']}  </option>
                                        HTML;
                                    }
                                    ?>
                                </select>
