<div class="content">
    <div class="form-auto">
        <div class="col-xs-12 table-list">
            <form action="btw" method="POST" class="listing__form">
                ...
                <div class="dashboardBoxBg mb30">
                    <div class="row">
                        <div class="table-list body1" style="width: 100%;">
                            ...
                            <input type="hidden" name="btw_insert">
                            ...
                            <div class="row str">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" autocomplete="off" name="BPMproductiedatum" id="datepicker1">
                                </div>
                                <div class="col-sm-2">
                                    Huidige datum BPM
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" autocomplete="off" name="huidigedatumbpm" id="datepicker2">
                                </div>
                            </div>
                            ...
                            <div class="row str">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" autocomplete="off" name="BPMtenaamstellingNL" id="datepicker3">
                                </div>
                                <div class="col-sm-2">
                                    Referentie
                                </div>
                            ...
                            <div class=" row str">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="addBTW_21" name="btw" placeholder="BTW 21%">
                                </div>
                                <div class="col-sm-1">
