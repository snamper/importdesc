						...
						<ul class="list-unstyled panel-list">
							<li>
								<div class="listWrapper">
									<div class="listName">
										<h3>Miku Toronto<small>by Adam Smith</small></h3>
									</div>
				...
				<div class="panel panel-default panel-card">
					...
					<div class="panel-body plr">
						<ul class="list-styled panel-list list-padding-sm">
							<li  class="listWrapper"><span class="recentUserInfo"><img src="assets/img/dashboard/recent-user-1.jpg" alt="Image User" class="img-circle">Adam Smith</span> <span class="userTime">Active 10m ago</span></li>
							<li  class="listWrapper"><span class="recentUserInfo"><img src="assets/img/dashboard/recent-user-2.jpg" alt="Image User" class="img-circle">Adam Smith</span> <span class="userTime">Active 12m ago</span></li>
							<li  class="listWrapper"><span class="recentUserInfo"><img src="assets/img/dashboard/recent-user-3.jpg" alt="Image User" class="img-circle">Adam Smith</span> <span class="userTime">Active 15m ago</span></li>
							...
							<li  class="listWrapper"><span class="recentUserInfo"><img src="assets/img/dashboard/recent-user-1.jpg" alt="Image User" class="img-circle">Adam Smith</span> <span class="userTime">Active 19m ago</span></li>
							<li  class="listWrapper"><span class="recentUserInfo"><img src="assets/img/dashboard/recent-user-2.jpg" alt="Image User" class="img-circle">Adam Smith</span> <span class="userTime">Active 14m ago</span></li>
							<li  class="listWrapper"><span class="recentUserInfo"><img src="assets/img/dashboard/recent-user-3.jpg" alt="Image User" class="img-circle">Adam Smith</span> <span class="userTime">Active 1h ago</span></li>
						</ul>
					</div>
				</div>
			</div>
