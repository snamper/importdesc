    ...
    <div class="panel-body">
        ...
        <form action="create_make" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="model_name_old" name="model_name_old" value="" placeholder="Model Name" required disabled/>
            </div>
            <div class="form-group">
                <label class="control-label">New Name<span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="model_name_new" name="model_name_new" value="" placeholder="New Name" required/>
            </div>
