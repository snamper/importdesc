...
$arrayCount = count($_POST['BPMArray']);
if ($arrayCount > 1) {    
$_POST['BPMArray'] = array_diff($_POST['BPMArray'], [0]);
} else{
...
//        $_POST["productiedatum"] = $_POST["productiedatum"];//ok
        ...
        $_POST['forfetaire_brutobpm']=$_POST["BPMproductiedatum"];// ok
             ...
             */
            NEW_forfetaire_berekening();
            NEW_forfetaire_berekening_variabel();
            NEW_forfetaire_berekening_tenaamstelling_nl();
...
function NEW_forfetaire_berekening() {
...
function NEW_forfetaire_berekening_variabel() {
...
function NEW_forfetaire_berekening_tenaamstelling_nl() {
...
$redirect_pagina = "../../../crm/bpmcalculator.php?SoortVoertuig=".$_POST['SoortVoertuig']."&BPMCO2=".$_POST['BPMCO2']."&BPMproductiedatum=".$_POST['BPMproductiedatum']."&BPMbrandstof=".$_POST['BPMbrandstof']."&BPMtenaamstellingNL=".$_POST["BPMtenaamstellingNL"]."&variabeledatumbpm=".$_POST['variabeledatumbpm']."&a=".$_POST['forfetaire_uitkomst']."&b=".$_POST['forfetaire_variabel_uitkomst']."&variabeledatumbpm=".$_POST['variabeledatumbpm']."&percentage=".$_POST['percentageX']."&percentagec=".$_POST['percentage'];
$return_arr[] = array(
