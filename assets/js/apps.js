...
var handleSettingCookie = function() {
	...
	$(document).on('change', '#setting_sidebar_inverse', function() {
		if ($(this).is(':checked')) {
	...
	if (Cookies.get('sidebar-inverse')) {
	...
	$(document).on('change', '#setting_sidebar_minified', function() {
		if ($(this).is(':checked')) {
	...
	if (Cookies.get('sidebar-minified')) {
	...
	$(document).on('change', '#setting_header_inverse', function() {
		if ($(this).is(':checked')) {
	...
	// Header Fixed Cookie 
	$(document).on('change', '#setting_fixed_header', function() {
		if ($(this).is(':checked')) {
	...
	$(document).on('change', '#setting_fixed_sidebar', function() {
		if ($(this).is(':checked')) {
