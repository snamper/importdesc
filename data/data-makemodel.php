 ...
 */
$aColumns = array( 'c.id_car_make','c.name', 'cm.name','cm.id_car_model','cm.id_car_make as edit','cm.id_car_model as modelid','c.id_car_make as carid');
...
while ( $aRow = mysqli_fetch_array( $rResult ) ) {
    ...
    for ( $i = 0; $i < count( $aColumns ); $i ++ ) {
        if ( $aColumns[ $i ] == "version" ) {
            ...
            $row[] = '<center style="display:flex;"><a href="#edit-mark" data-toggle="modal" class="btn btn-default btn-xs"><i class="ti-pencil" ></i></a><a href="#default-modal" data-toggle="modal" class="btn btn-default btn-xs"><i class="ti-close" ></i></a></center>';
        }elseif ( $aColumns[ $i ] == 'cm.id_car_make as edit' ) {
            $row[] = '<center style="display:flex;"><a href="#edit-model" data-toggle="modal" class="btn btn-default btn-xs"><i class="ti-pencil" ></i></a><a href="#default-modal" data-toggle="modal" class="btn btn-default btn-xs"><i class="ti-close" ></i></a></center>';
        }  elseif ( $aColumns[ $i ] != ' ' ) {
            /* General output */
            $row[] = $aRow[$i];
        }
